...
class OSTrack(nn.Module):
    ...
    def __init__(self, transformer, box_head, aux_loss=False, head_type="CORNER"):
        ...
        for name, module in self.named_modules():
            ...
            # if "conv1_ctr.0" in name:
            #     self.hooks.append(module.register_full_backward_hook(self.get_gradient))
    ...
    def importance(self, out_dict):
        n, _, _ = out_dict['backbone_feat'].shape
        score = out_dict['score_map'].reshape(n, -1)
        ...
        # with torch.no_grad():
        #     g_vis = cv2.resize(grad.reshape(16, 16).numpy(), (256, 256))
        #     plt.imshow(g_vis)
        #     plt.show()
