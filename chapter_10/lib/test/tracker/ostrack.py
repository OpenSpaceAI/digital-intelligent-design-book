...
class OSTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        #     network, {torch.nn.Conv2d, torch.nn.Linear}, dtype=torch.qint8
        # )
    ...
    def track(self, image, info: dict = None):
        ...
        #         **{
        #             "inputs": [torch_tensorrt.Input([1, 3, 128, 128]), torch_tensorrt.Input([1, 3, 256, 256]),
        #                        torch_tensorrt.Input([1, 64])],
        ...
        #     )
        # }
        # trt_model = torch._C._jit_to_backend("tensorrt", self.network, spec)
