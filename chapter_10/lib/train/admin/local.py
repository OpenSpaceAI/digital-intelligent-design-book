...
class EnvironmentSettings:
    def __init__(self):
        ...
        self.visualgenome_dir = '/zssd/myc/VOT/VOT/geome'
        self.otb99_dir = os.path.join(prj_dir, 'data/otb99')
        self.refcoco_dir = '/zhdd/dataset/VLTVG/data/other' # '/ssd/dataset/VOT/refcocog'
        self.webuav_dir = '/zssd/myc/VOT/VOT/webuav'